...
f3 = map_plot(air, show_stat=False, use_basemap=True,title='show_stat=True',ax=ax3)
f4 = map_plot(air, show_stat=False, stat_type='median', use_basemap=True, title='show_stat=True,stat_type="median"', ax=ax4)
